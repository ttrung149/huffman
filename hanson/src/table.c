...
*   File name: table.c
*
*   Description: David R. Hanson's implementation of a dictionary
*   in C. All rights reserved to David R. Hanson. For more
*   information, see Hanson's source code on Github at:
*
